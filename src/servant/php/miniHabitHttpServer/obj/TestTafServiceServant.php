...
namespace HttpServer\servant\php\miniHabitHttpServer\obj;
...
use HttpServer\servant\php\miniHabitHttpServer\obj\classes\LotofTags;
use HttpServer\servant\php\miniHabitHttpServer\obj\classes\SimpleStruct;
use HttpServer\servant\php\miniHabitHttpServer\obj\classes\OutStruct;
use HttpServer\servant\php\miniHabitHttpServer\obj\classes\ComplicatedStruct;
class TestTafServiceServant {
	protected $_communicator;
	protected $_iVersion;
	protected $_iTimeout;
	public $_servantName = "php.miniHabitHttpServer.obj";
